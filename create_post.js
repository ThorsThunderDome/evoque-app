// create_post.js - FINAL, COMPLETE VERSION
    ...
    createPostForm.addEventListener('submit', async (e) => {
        ...
        try {
            if (mediaFile && mediaType !== 'none') {
                const mediaPath = `postMedia/${piUser.uid}/${Date.now()}_${mediaFile.name}`; // CORRECTED PATH
...
document.addEventListener('DOMContentLoaded', initializeCreatePost);
